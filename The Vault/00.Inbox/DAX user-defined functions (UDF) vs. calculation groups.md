...
created: 2026-08-04
description: "This article describes the different roles of user-defined functions and calculation groups, explaining when to use either, and how they complement each oth"
...
![](99.System/Attachments/image1-128.png)
...
![](99.System/Attachments/image2-124.png)
...
![](99.System/Attachments/image3-111.png)
...
VARNewCustomers =
    FILTER(
        ...
        [@NewCustomerDate]INVALUES('Date'[Date])
    )
VARResult =
    CALCULATE(
        SELECTEDMEASURE(),
...
VARExistingCustomers =
    FILTER(
        CustomersWithNewDate,
        [@NewCustomerDate]< MinDate
    )
VARReturningCustomers =
    SELECTCOLUMNS(
        ExistingCustomers,
...
DaxPatterns.NewReturning.Absolutes.NewCustomers =(
    ...
    FILTER(
        ...
        [@NewCustomerDate]INVALUES(DateColumn )
    )
```
...
![](99.System/Attachments/image4-105-scaled.png)
...
One could argue that every single calculation should be written as a UDF, with measures and calculation items serving merely as function calls with the appropriate parameters. We do not suggest going to this extreme. If a measure contains a simple [SUM](https://dax.guide/sum/?aff=sqlbi) or a straightforward subtraction, there is no benefit in wrapping it inside a function. Moving a simple operation into a function only hides the calculation and makes the code harder to read.
