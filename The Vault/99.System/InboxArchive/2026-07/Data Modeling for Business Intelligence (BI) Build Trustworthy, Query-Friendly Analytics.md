---
title: "Data Modeling for Business Intelligence (BI): Build Trustworthy, Query-Friendly Analytics"
source: "https://medium.com/@hanxuyang0826/data-modeling-for-business-intelligence-bi-build-trustworthy-query-friendly-analytics-e5a8a340fc3e"
author:
  - "[[Lagu]]"
...
> *Good modeling makes simple questions easy. Bad modeling makes simple questions hard.*
...
- customer dimension (segment, country, signup\_channel)
- product dimension (category, brand, price\_tier)
- date dimension (month, quarter, fiscal\_year, week\_number)
...
- additive: sum across all dimensions (sales\_amount)
- semi-additive: additive across some dimensions but not time (account\_balance)
...
- `orders` (order\_id, customer\_id, order\_date, status)
- `order_items` (order\_id, product\_id, quantity, unit\_price)
- `customers` (customer\_id, segment, country)
- `products` (product\_id, category, brand)
