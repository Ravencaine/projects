...
created: 2026-08-04
description: "This article shows how to use calculation groups to change the active relationship in a model in order to let users choose among multiple dates. It is commo"
...
When you have multiple relationships in a model, the engine uses the active relationship by default. If needed, you can use [CALCULATE](https://dax.guide/calculate/?aff=sqlbi) and the [USERELATIONSHIP](https://dax.guide/userelationship/?aff=sqlbi) modifier to change the active relationship. Thus, you can author these two measures to compute the sales amount and the delivered amount:
...
![](99.System/Attachments/image2-3.png)
