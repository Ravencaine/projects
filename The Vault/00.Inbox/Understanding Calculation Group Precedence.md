...
![](99.System/Attachments/Calculation-groups-4-Precedence-02.png)
...
![](99.System/Attachments/Calculation-groups-4-Precedence-04.png)
...
Then, DAX applies the **Daily AVG** calculation item from the *Averages* calculation group, replacing the measure reference with the [DIVIDE](https://dax.guide/divide/?aff=sqlbi) function and obtaining the following expression:
