...
created: 2026-08-04
description: "This article describes how to control the execution of DAX code when there are either multiple or empty selections of calculation items in calculation group"
...
![](99.System/Attachments/image1-108.png)
...
![](99.System/Attachments/image2-105.png)
...
K =
IF(
    NOTCONTAINSSTRING(SELECTEDMEASURENAME(),"%"),
...
![](99.System/Attachments/image3-95.png)
...
![](99.System/Attachments/image4-89.png)
...
![](99.System/Attachments/image5-79.png)
...
2. Create the script for the calculation group
	1. Right-click the calculation group in the Model pane
		...
		3. Click “Script tab”
	![](99.System/Attachments/image6-72.png)
...
![](99.System/Attachments/image7-61.png)
...
If two or more calculation items are selected, we no longer see the contents of the visual; we see an error with the message we defined in the [ERROR](https://dax.guide/error/?aff=sqlbi) function, which is highlighted in the following screenshot.

![](99.System/Attachments/image8-50.png)
...
calculationGroup
    multipleOrEmptySelectionExpression =\`\`\`
            VARmaxSelection =MAX('Unit measure C'[Ordinal])
            VARselection =
                LOOKUPVALUE(
...
![](99.System/Attachments/image9-44.png)
...
![](99.System/Attachments/image10-38.png)
...
![](99.System/Attachments/image11-29.png)
...
calculationGroup
    multipleOrEmptySelectionExpression =\`\`\`
        VARsel_YTD_PY ={"YTD","PY"}
        VARsel_YTD_YOY ={"YTD","YOY"}
        VARselection =VALUES('Time Intelligence'[Name])
        RETURNSWITCH(
            TRUE,
...
![](99.System/Attachments/image13-19.png)
...
calculationGroup
    ...
    noSelectionExpression =\`\`\`
        ...
        IF(
            ...
            CALCULATE(
                VARSelectedCurrency =SELECTEDVALUE('Currency'[Currency Code],"USD")
                VARMeasureName =SELECTEDMEASURENAME()
                VARSkipConversion =CONTAINSSTRING(MeasureName,"#")
...
![](99.System/Attachments/image14-13.png)

Pay attention to the code that implements the calculation item value and the format string: the initial [ISCROSSFILTERED](https://dax.guide/iscrossfiltered/?aff=sqlbi) is redundant in this simple example. However, it is a helpful technique to optimize the execution when the calculation is unnecessary because the *Currency* table is not referenced in the report.
